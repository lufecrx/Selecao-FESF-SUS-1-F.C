...
# Sincronous SQLite URL (para operações de criação de tabelas)
DATABASE_URL = os.getenv("DATABASE_URL", "sqlite:///./vidaplena.db")

# Async SQLite URL para operações assíncronas (aiosqlite)
ASYNC_DATABASE_URL = os.getenv("ASYNC_DATABASE_URL", "sqlite+aiosqlite:///./vidaplena.db")
